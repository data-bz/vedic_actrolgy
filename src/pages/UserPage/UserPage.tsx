    ...
    const sendMessage = async (userId: any, message: string) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setMessage("");
                setChat([...chat, { type: 'human', message }]); // Добавление нового сообщения в чат
            } else {
            ...
            <div className={s.innerContainer}>
                ...
                }
                {
                    ...
                    <div className={s.messages}>
                        {
                            chat?.map((elem: any) =>
                                <div key={elem.id} className={elem.type == "human" ? s.humanMessageContainer : s.botMessageContainer}>
